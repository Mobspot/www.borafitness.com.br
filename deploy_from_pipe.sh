...
sudo rm -R /var/www/html/borafitness.com.br/*
sudo cp -R ~/www.borafitness.com.br /var/www/html/borafitness.com.br
sudo cp ~/www.borafitness.com.br/wp-config-sample.php /var/www/html/borafitness.com.br/wp-config.php
